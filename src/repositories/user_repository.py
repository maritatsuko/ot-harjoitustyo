...
class UserRepository:
    ...
    def find_by_username(self, username):
        ...
        row = cursor.fetchone()
        # Debug statement
        print(f"Debug: Row fetched for username '{username}': {row}")
    ...
    def create(self, user):
        ...
        # Debug statement
        print(
            f"Debug: Hashed password for user '{user.username}': {hashed_password.decode('utf-8')}")
    ...
    def verify_password(self, username, password):
        ...
        # Debug statement
        print(
            f"Debug: Hashed password for username '{username}': {user.password}")
